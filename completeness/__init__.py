"""Reproducible completeness-audit package.

Turns the manual adversarial-coverage pass into provenance-backed code:
  frame_reconcile.py   — our `program` table vs. authoritative external inventories
