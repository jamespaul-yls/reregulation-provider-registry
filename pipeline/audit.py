...
def audit(db_path: Path) -> list[str]:
    ...
    # See pipeline/export.py: pin session TimeZone so any TIMESTAMPTZ value surfaced
    # in an error message is UTC, not whatever timezone the host OS happens to be in.
