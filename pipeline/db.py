...
class RegistryStore:
    ...
    def conn(self) -> duckdb.DuckDBPyConnection:
        if self._conn is None:
            ...
            # Pin session TimeZone so TIMESTAMPTZ columns (retrieved_at, reviewed_at)
            # always render in UTC, not whatever timezone the host OS happens to be in.
            # See pipeline/export.py for why this matters for reproducibility.
